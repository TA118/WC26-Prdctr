...
export const R32: MatchDef[] = [
  ...
  { id: 75,  top: W('F'), bottom: R('C'),                kickoff: '2026-06-29T01:00:00Z', venue: 'Guadalajara' },
  { id: 76,  top: W('C'), bottom: R('F'),                kickoff: '2026-06-29T16:00:00Z', venue: 'Houston' },
  ...
  { id: 79,  top: W('A'), bottom: T('C','E','F','H','I'), kickoff: '2026-06-30T01:00:00Z', venue: 'Mexico City' },
  { id: 80,  top: W('L'), bottom: T('E','H','I','J','K'), kickoff: '2026-07-01T16:00:00Z', venue: 'Atlanta' },
  { id: 81,  top: W('D'), bottom: T('B','E','F','I','J'), kickoff: '2026-07-01T00:00:00Z', venue: 'San Francisco' },
  ...
  { id: 85,  top: W('B'), bottom: T('E','F','G','I','J'), kickoff: '2026-07-02T02:00:00Z', venue: 'Vancouver' },
  { id: 86,  top: W('J'), bottom: R('H'),                kickoff: '2026-07-03T22:00:00Z', venue: 'Miami' },
  { id: 87,  top: W('K'), bottom: T('D','E','I','J','L'), kickoff: '2026-07-03T01:30:00Z', venue: 'Kansas City' },
